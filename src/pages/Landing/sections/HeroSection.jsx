...
<<<<<<< Updated upstream:src/components/Hero/Hero.jsx

<<<<<<< Updated upstream:src/pages/Landing/sections/HeroSection.jsx
export default function HeroSection() {
=======
export default function Hero() {
=======
export default function HeroSection() {
>>>>>>> Stashed changes:src/pages/Landing/sections/HeroSection.jsx
>>>>>>> Stashed changes:src/components/Hero/Hero.jsx
  return (
    <section className="relative h-screen flex items-center justify-start overflow-hidden antialiased">
      ...
      <div className="relative z-20 max-w-xl px-12 pt-16">
        <div className="inline-flex items-center gap-1.5 text-xs font-semibold tracking-widest px-3 py-1 rounded-full mb-6 text-white border border-white/30 bg-white/15 backdrop-blur-sm ring-1 ring-white/10 hover:ring-white/50">
        ...
        <div className="flex gap-6 flex-wrap">
          ...
          <div className="flex items-center gap-1.5 text-xs text-white/85">
            <div className="w-3.5 h-3.5 rounded-full flex items-center justify-center text-secondary bg-secondary/25 text-[9px]">✓</div>
            Envio único de receita

          </div>
          <div className="flex items-center gap-1.5 text-xs text-white/85">
            <div className="w-3.5 h-3.5 rounded-full flex items-center justify-center text-primary-light bg-primary-light/30 text-[9px]">✓</div>
            Compare preços
